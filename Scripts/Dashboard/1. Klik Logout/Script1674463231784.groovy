...
WebUI.click(findTestObject('Object Repository/Dashboard/i_Dashboard_oxd-icon bi-caret-down-fill oxd_d2fd49'))

WebUI.verifyElementText(findTestObject('Object Repository/Dashboard/a_Logout'), 'Logout')
